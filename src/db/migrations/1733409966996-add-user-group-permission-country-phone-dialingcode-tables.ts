...
export class AddUserGroupPermissionCountryPhoneDialingcodeTables1733409966996
  implements MigrationInterface
{
  name = 'AddUserGroupPermissionCountryPhoneDialingcodeTables1733409966996';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "country" ("id" SERIAL NOT NULL, "country" character varying(200) NOT NULL, "countryISOCode2" character(2) NOT NULL, "countryDialingCodeId" integer, CONSTRAINT "UQ_f9c25d6ae5734b405b890d0ee52" UNIQUE ("country"), CONSTRAINT "UQ_394ebe607777c043029cb9a46bc" UNIQUE ("countryISOCode2"), CONSTRAINT "REL_5eee72b4d8ee2f0e409f4a6d82" UNIQUE ("countryDialingCodeId"), CONSTRAINT "PK_bf6e37c231c4f4ea56dcd887269" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "country" ADD CONSTRAINT "FK_5eee72b4d8ee2f0e409f4a6d82a" FOREIGN KEY ("countryDialingCodeId") REFERENCES "country_dialing_code"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "country" DROP CONSTRAINT "FK_5eee72b4d8ee2f0e409f4a6d82a"`,
    );
    await queryRunner.query(
